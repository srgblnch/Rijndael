...
def unitTest(debug=False):
    ...
    debug_stream("subkey",subkey,0,"cipher->addRoundKey()\t")
    ...
    state = [[0x19,0xa0,0x9a,0xe9],
             ...
             [0xe3,0xe2,0x8d,0x48],
             [0xbe,0x2b,0x2a,0x08]]
    debug_stream("state",state,0,"cipher->subBytes()\t")
    ...
    state = [[0xd4,0xe0,0xb8,0x1e],
             ...
             [0x11,0x98,0x5d,0x52],
             [0xae,0xf1,0xe5,0x30]]
    debug_stream("state",state,0,"cipher->shiftRows()\t")
    ...
    state = [[0xd4,0xe0,0xb8,0x1e],
             ...
             [0x5d,0x52,0x11,0x98],
             [0x30,0xae,0xf1,0xe5]]
    debug_stream("state",state,0,"cipher->MixColumns()\t")
