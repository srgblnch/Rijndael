...
# To understand the Sbox, imagine that your cell in the state matrix is 0x53,
# Then search in the sbox the row 5 column 3, should be 0xED.
# To undo it, in the deciphering the same cell of the state matrix will have the value 0xED
# Then search in the inverted sbos the row 'E' column 'D', should be 0x53
